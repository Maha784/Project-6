...
async function trackHealthMetrics(email, metricData) {
    return await persistence.trackHealthMetrics(email, metricData);
}

async function getHealthMetrics(email) {
    return await persistence.getHealthMetrics(email);
}
...
async function submitUserFeedback(feedbackData) {
    return await persistence.submitUserFeedback(feedbackData);
}
